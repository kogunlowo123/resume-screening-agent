"""Resume Screening Agent - Main Agent Implementation."""
...
class ResumeScreeningAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.resume_parsing_enabled = True
        self.requirement_matching_enabled = True
        self.candidate_scoring_enabled = True
        self.skill_gap_analysis_enabled = True
        self.bias_mitigation_enabled = True
        self._tool_dispatch = {
            "parse_resume": self.tools.parse_resume,
            "match_requirements": self.tools.match_requirements,
            "score_candidate": self.tools.score_candidate,
            "detect_skill_gaps": self.tools.detect_skill_gaps,
            "rank_candidates": self.tools.rank_candidates,
        }
        logger.info(
            "agent_initialized",
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "detect_skill_gaps": ['detect', 'skill', 'gaps'],
